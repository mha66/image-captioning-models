...
## Vision–Language Models with Streamlit Demo

<img width="1600" height="867" alt="image" src="https://github.com/user-attachments/assets/2f139bd2-69b3-4091-bf28-bf19b80c9259" />

---
This project implements an **Image Captioning system** using multiple **Encoder–Decoder (Vision–Language)** architectures.  
...
- 🖼️ **Vision Encoders:** ViT, CLIP  
- 📝 **Text Decoders:** GPT-2, DistilGPT-2  
...
This project compares **three different vision–language model combinations**:
...
### 2️⃣ ViT + DistilGPT-2 ⭐ (Best Overall)
- **Encoder:** `google/vit-base-patch16-224`
- **Decoder:** `distilgpt2`
...
- **Decoder:** `gpt2`
- Benefits from CLIP’s image–text pretraining but is more computationally expensive.
